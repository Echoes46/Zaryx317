...
public class Configuration {
    ...
    public static String[] YOUTUBERS = { "rsps vider" };
	...
	public static final String DONATOR_BENEFITS_LINK = "https://discord.gg/fnP3RetqjE";
	public static final String PRICE_GUIDE = "https://discord.gg/fnP3RetqjE";
	...
	public static int PLAYER_SAVE_BACKUP_EVERY_X_SAVE_TICKS = 5;
	...
	public static boolean DISABLE_BLACKJACK = false;
	...
	public static final int[] UNDEAD_NPCS = {
			...
			6462,6463,6464,6465,6466,6467,6468,6596,6597,6598,6741, Npcs.SKELETON_HELLHOUND, 8026, 8027, 8028, 7413, Npcs.PESTILENT_BLOAT, 10812, 10813,
	...
	public static final int START_LOCATION_Y = 3511;

	public static final Position START_POSITION = new Position(START_LOCATION_X, START_LOCATION_Y);

	public static final Position START_POSITION_WILDYMAN_GROUP = new Position(3442, 3838);
	 ...
	 */
	public static final int DUELING_RESPAWN_X = 3087;
	public static final int DUELING_RESPAWN_Y = 3500;
