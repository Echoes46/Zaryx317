package io.zaryx.model.cycleevent;
...
public class EventHandler {
	 ...
	 */
	private final Queue<Event<?>> pendingAddition = new LinkedList<>();

	/**
	 * A list of all the events that need to be removed from the list of running events.
	 */
	private final Queue<Event<?>> pendingRemoval = new LinkedList<>();

	/**
	 * A list of the currently running events
	 */
	private final Queue<Event<?>> active = new LinkedList<>();
