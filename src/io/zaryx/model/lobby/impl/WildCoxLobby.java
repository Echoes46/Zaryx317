package io.zaryx.model.lobby.impl;
...
public class WildCoxLobby extends Lobby {
	...
	public void onJoin(Player player) {
		player.getPA().movePlayer(3180,3725);
	...
	public void onLeave(Player player) {
		player.getPA().movePlayer(3180, 3725, 0);
