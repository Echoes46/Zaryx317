package io.zaryx.model.entity.npc.data;
...
public class AttackAnimation extends NPCHandler {
	...
	public static int handleEmote(NPC npc) {
		...
		switch (npc.getNpcId()) {
			...
			case 8611:
				return 8270;
			case 12214: // Leviathan's NPC ID
				if (npc.getAttackType() == CombatType.MAGE) {
					return 10280; // Mage orb attack animation
				} else if (npc.getAttackType() == CombatType.RANGE) {
					return 10280; // Range orb attack animation
				}  else if (npc.getAttackType() == CombatType.SPECIAL) {
					return 10282; // Range orb attack animation
				}
			...
			case 3718: //Vyrewatch fflying things
			case 3713:
			case 3714:
			case 3715:
			case 3716:
			...
			case 9400:
				return npc.getAttackType() == CombatType.RANGE ? 409 : npc.getAttackType() == CombatType.MAGE ? 811 : 386;
			case 8164:
			case 8172:
			case 13201:
				return npc.getAttackType() == CombatType.RANGE ? 426 : 1978;
			case 6610:
				return 9991;
			case 419: // Cockatrice
			case 8781:
