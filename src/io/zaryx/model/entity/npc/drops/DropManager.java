...
import io.zaryx.content.bosses.grotesqueguardians.GrotesqueInstance;
...
import static io.zaryx.model.Items.*;
...
public class DropManager {
    ...
    static int[] revs = {7881, 7931, 7932, 7933, 7934, 7935, 7936, 7937, 7938, 7939, 7940};
    ...
    public static void dropBloodMoney(Player player, int npcId, int dropX, int dropY, int dropZ) {
        if (player.getMode().isGroupWildyman() || player.getMode().isWildyman()) {
            NpcDef npcDefinition = NpcDef.forId(npcId);
            if (npcDefinition != null && Misc.random(2) == 1) {
                ...
                if ((player.getItems().isWearingItem(12785)) && player.collectCoins || (player.getItems().isWearingItem(2572)) && player.collectCoins || (player.getItems().isWearingItem(20790)) && player.collectCoins || (player.getItems().isWearingItem(20789)) && player.collectCoins || (player.getItems().isWearingItem(20788)) && player.collectCoins || (player.getItems().isWearingItem(20787)) && player.collectCoins || (player.getItems().isWearingItem(20786)) && player.collectCoins) {
                    player.getItems().addItem(13307, amount);
    ...
    public static void pointboostsword(Player player, int npcId, int dropX, int dropY, int dropZ) {
        if (player.getItems().isWearingItem(6721)) {
            NpcDef npcDefinition = NpcDef.forId(npcId);
            if (npcDefinition != null && Misc.random(2) == 1) {
                int amount = 250;
                if (player.collectCoins) {
                    player.getItems().addItem(33237, amount);
                } else {
                    Server.itemHandler.createGroundItem(player, 33237, dropX, dropY, dropZ, amount, player.getIndex());
                }
            }
        }
    }

    public static void pointboostrelic(Player player, int npcId, int dropX, int dropY, int dropZ) {
        if (player.getItems().hasItemOnOrInventory(26090)) {
            NpcDef npcDefinition = NpcDef.forId(npcId);
            if (npcDefinition != null && Misc.random(2) == 1) {
                int amount = 100;
                if (player.collectCoins) {
    ...
    public static void jaftring(Player player, int npcId, int dropX, int dropY, int dropZ) {
        if (player.getItems().isWearingItem(26314)) {
            NpcDef npcDefinition = NpcDef.forId(npcId);
            if (npcDefinition != null && Misc.random(1) == 1) {
                int amount = 200;
                if (player.collectCoins) {
                    player.getItems().addItem(33237, amount);
                } else {
    ...
    public static void implamp(Player player, int npcId, int dropX, int dropY, int dropZ) {
        if (player.petSummonId == 30011) {
            ...
            if (npcDefinition != null && Misc.random(225) == 1) {
                int amount = 1;
                if (player.collectCoins) {
                    player.getItems().addItem(2528, amount);
                } else {
                    Server.itemHandler.createGroundItem(player, 2528, dropX, dropY, dropZ, amount, player.getIndex());
                }
            }
        }
    }
    ...
    public static void wildyManKey(Player player, int npcId, int dropX, int dropY, int dropZ) {
        if (player.getMode().isGroupWildyman() && player.wildymanset() || player.getMode().isWildyman() && player.wildymanset()) {
            NpcDef npcDefinition = NpcDef.forId(npcId);
            if (npcDefinition != null && Misc.random(500) == 1) {
                int amount = 1;
                player.sendMessage("You manage to retrieve a valuable key " + npcDefinition.getName() + " This must be worth a fortune.");
                Server.itemHandler.createGroundItem(player, 13302, dropX, dropY, dropZ, amount, player.getIndex());
            }
        }
    }
    ...
    public void handle(Player player, NPC npc, Location3D location, int repeats, int npcId) {
        ...
        if (Misc.random(ResourceBox) == 1) {
            ...
            if (mediumNpc) {
                specialItemId = 30001;
                player.sendMessage("@bla@You notice a @blu@Resource box@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountbox, player.getIndex());
            } else if (largeNpc) {
                specialItemId = 30002;
                player.sendMessage("@bla@You notice a @blu@Resource box@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountbox, player.getIndex());
        ...
        if (player.getPosition().inWild()) {
            wildyManKey(player, npcId, location.getX(), location.getY(), location.getZ());
        }

        if (player.getItems().hasItemOnOrInventory(26090)) {
            pointboostrelic(player, npcId, location.getX(), location.getY(), location.getZ());
        }

        if (player.getItems().isWearingItem(6721)) {
            pointboostsword(player, npcId, location.getX(), location.getY(), location.getZ());
        }
        ...
        if (Misc.random(sinisterRandom) == 1) {
            ...
            if (player.hasFollower &&
                ...
                if (player.getItems().freeSlots() > 0) {
                    ...
                    player.getItems().addItem(specialItemId, amountKey + extraKey);
                } else {
                    player.sendMessage("@bla@You notice a @red@key of the forest@bla@ on the floor.");
                    Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountKey, player.getIndex());
                }
            } else {
                player.sendMessage("@bla@You notice a @red@key of the forest@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountKey, player.getIndex());
        ...
        if (Misc.random(ticketRandom) == 1) {
            ...
            if (player.hasFollower &&
                ...
                if (player.getItems().freeSlots() > 0) {
                    ...
                    player.getItems().addItem(specialItemId, amountKeys + extraKey);
                } else {
                    player.sendMessage("@bla@[@red@Pet@bla@] Your pet noticed a @red@Upgrade ticket,@bla@ but your inventory is full!");
                    Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountKeys, player.getIndex());
                }
            } else {
                player.sendMessage("@bla@You notice a @red@Upgrade ticket@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountKeys, player.getIndex());
            }
        }
        ...
        if (player.getItems().isWearingItem(26939)) {
            amountBox1 = 2;
        }
        if (Misc.random(RealmBoxRandom) == 1) {
            specialItemId = 6678;
            int extraKey = 0;
            if (player.hasFollower &&
                    ((player.petSummonId == 30022) && petPerkChance < 100)) {
                if (player.getItems().freeSlots() > 0) {
                    ...
                    player.getItems().addItem(specialItemId, amountBox1 + extraKey);
                } else {
                    player.sendMessage("@bla@[@red@Pet@bla@] Your pet noticed a @red@Realm box,@bla@ but your inventory is full!");
                    Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountBox1, player.getIndex());
                }
            } else {
                player.sendMessage("@bla@You notice a @red@Realm box@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountBox1, player.getIndex());
            }
        }
        ...
        if (Misc.random(BoxRandom) == 1) {
            ...
            if (player.hasFollower &&
                ...
                if (player.getItems().freeSlots() > 0) {
                    ...
                    player.getItems().addItem(specialItemId, amountBox + extraKey);
                } else {
                    player.sendMessage("@bla@[@red@Pet@bla@] Your pet noticed a @red@Myriad of Boxes,@bla@ but your inventory is full!");
                    Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountBox, player.getIndex());
                }
            } else {
                player.sendMessage("@bla@You notice a @red@Myriad of Boxes@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountBox, player.getIndex());
            }
        }

        int warpedRandom = 350;
        int amountKey2 = 1;
        if (Hespori.activeGolparSeed) {
            amountKey2 = 2;
        }
        ...
        if (Misc.random(warpedRandom) == 1 && player.wildLevel >= 60) {
            specialItemId = 3468;
            correctPetId = 30010;
            int extraKey = 0;
            boolean hasDarkVersion = (player.petSummonId == 30110 || player.petSummonId == 30122);
            if (player.hasFollower &&
                ...
                if (player.getItems().freeSlots() > 0) {
                    ...
                    player.getItems().addItem(specialItemId, amountKey2 + extraKey);
                } else {
                    player.sendMessage("@bla@You notice a @red@Warped Key@bla@ on the floor.");
                    Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountKey2, player.getIndex());
                }
            } else {
                player.sendMessage("@bla@You notice a @red@Warped Key@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), amountKey2, player.getIndex());
        ...
        String name = npc.getDefinition().getName().toLowerCase().replaceAll("_", "");
        if (Misc.random(Slayer1) == 1 && task.isPresent() && name.equals(task.get().getPrimaryName())) {
            correctPetId = 30010;
            specialItemId = 28416;
            int extraKey = 0;
            boolean hasDarkVersion = (player.petSummonId == 30110 || player.petSummonId == 30122);
            if (player.hasFollower &&
                ...
                player.sendMessage("@bla@You notice a @blu@Slayer key (tier1)@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), Slayerkey1, player.getIndex());
            }
        ...
        if (Misc.random(Slayer2) == 1 && task.isPresent() && name.equals(task.get().getPrimaryName())) {
            specialItemId = 28417;
            correctPetId = 30010;
            int extraKey = 0;
            boolean hasDarkVersion = (player.petSummonId == 30110 || player.petSummonId == 30122);
            if (player.hasFollower &&
                ...
                player.sendMessage("@bla@You notice a @blu@Slayer key (tier2)@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), Slayerkey2, player.getIndex());
            }
            if (player.getItems().hasItemOnOrInventory(22943)) {
                if (Misc.random(0, 100) > 75)
        ...
        if (Misc.random(Slayer3) == 1 && task.isPresent() && name.equals(task.get().getPrimaryName())) {
            specialItemId = 28418;
            correctPetId = 30010;
            int extraKey = 0;
            boolean hasDarkVersion = (player.petSummonId == 30110 || player.petSummonId == 30122);
            if (player.hasFollower &&
                ...
                player.sendMessage("@bla@You notice a @blu@Slayer key (tier3)@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), Slayerkey3, player.getIndex());
            }
            if (player.getItems().hasItemOnOrInventory(22943)) {
                if (Misc.random(0, 100) > 75)
        ...
        if (Misc.random(Slayer4) == 1 && task.isPresent() && name.equals(task.get().getPrimaryName())) {
            specialItemId = 28419;
            correctPetId = 30010;
            int extraKey = 0;
            boolean hasDarkVersion = (player.petSummonId == 30110 || player.petSummonId == 30122);
            if (player.hasFollower &&
                ...
                player.sendMessage("@bla@You notice a @blu@Slayer key (tier4)@bla@ on the floor.");
                Server.itemHandler.createGroundItem(player, specialItemId, location.getX(), location.getY(), location.getZ(), Slayerkey4, player.getIndex());
        ...
        if (Boundary.isIn(npc, Boundary.CATACOMBS)) {
            if (Misc.random(100) == 1) {
                ...
                Server.itemHandler.createGroundItem(player, 19677, location.getX(), location.getY(), location.getZ(), 1, player.getIndex());
                player.sendMessage("@red@You notice a @whi@Ancient crystal @red@being dropped to the ground");
            }
    ...
    public void openForNpcId(Player player, int npcId) {
        ...
        group.ifPresent(g -> {
            ...
            // Loads the definition and max hit/aggressiveness to display
            ...
            // Clear any remaining slots if drop size is less than 80
...
//		}
        ...
        if (item.getId() == 11681 && player.collectCoins && (player.getItems().freeSlots() > 0 || player.getItems().playerHasItem(995))) {
            if ((player.getItems().isWearingItem(12785)) || (player.getItems().isWearingItem(26939)) || (player.getItems().isWearingItem(2572)) || (player.getItems().isWearingItem(26314)) || (player.getItems().isWearingItem(20790)) || (player.getItems().isWearingItem(20789)) || (player.getItems().isWearingItem(20788)) || (player.getItems().isWearingItem(20787)) || (player.getItems().isWearingItem(20786))) {
                ...
                item.changeDrop(-1, item.getAmount());
                player.sendMessage("@red@The ring of wealth has collected the dropped @whi@ Scrap");
            }
        }

        if (item.getId() == 13307 && player.collectCoins && (player.getItems().freeSlots() > 0 || player.getItems().playerHasItem(995))) {
            if ((player.getItems().isWearingItem(12785)) || (player.getItems().isWearingItem(26939)) || (player.getItems().isWearingItem(2572)) || (player.getItems().isWearingItem(26314)) || (player.getItems().isWearingItem(20790)) || (player.getItems().isWearingItem(20789)) || (player.getItems().isWearingItem(20788)) || (player.getItems().isWearingItem(20787)) || (player.getItems().isWearingItem(20786))) {
        ...
        if (item.getId() == 33237 && player.collectCoins && (player.getItems().freeSlots() > 0 || player.getItems().playerHasItem(995))) {
            if ((player.getItems().isWearingItem(12785)) || (player.getItems().isWearingItem(26939)) || (player.getItems().isWearingItem(2572)) || (player.getItems().isWearingItem(26314)) || (player.getItems().isWearingItem(20790)) || (player.getItems().isWearingItem(20789)) || (player.getItems().isWearingItem(20788)) || (player.getItems().isWearingItem(20787)) || (player.getItems().isWearingItem(20786))) {
