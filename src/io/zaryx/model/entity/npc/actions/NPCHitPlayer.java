...
import io.zaryx.content.bosses.Scorpia;
...
import io.zaryx.content.combat.effects.damageeffect.impl.SerpentineHelmEffect;
import io.zaryx.content.combat.formula.CombatFormula;
import io.zaryx.content.combat.formula.MagicMaxHit;
import io.zaryx.content.combat.formula.MeleeMaxHit;
import io.zaryx.content.combat.formula.RangeMaxHit;
...
import io.zaryx.content.combat.npc.NPCAutoAttackDamage;
...
public class NPCHitPlayer {
    ...
    public static CombatHit applyAutoAttackDamage(NPC npc, Player c, NPCAutoAttack npcAutoAttack) {
        ...
        /*if (damage > 0) {
            if (CombatPrayer.isPrayerOn(c, CombatPrayer.SOUL_SPLIT)) {
                applySoulSplitOnNpc(c, damage, npc);
    ...
    public static void applySoulSplitOnNpc(Player c, int damage, NPC npc) {
                        ...
                        case MELEE:
                            ...
                            switch (npc.getNpcId()) {
                                ...
                                case 423:
                                    ...
                                    break;
                                case 13201:
                                if (!c.getItems().isWearingAnyItem(2572) &&
                                    !c.getItems().isWearingAnyItem(12785) &&
                                    !c.getItems().isWearingAnyItem(20790) &&
                                    !c.getItems().isWearingAnyItem(20789) &&
                                    !c.getItems().isWearingAnyItem(20788) &&
                                    !c.getItems().isWearingAnyItem(20787) &&
                                    !c.getItems().isWearingAnyItem(20786)) {
                        ...
                        case DRAGON_FIRE:
                            ...
                            boolean isProtected =
                                    ...
                                    c.getItems().isWearingItem(11284) ||
                                             ...
                                             * armour of oz
                                             */
                                            c.getItems().isWearingItem(33195) ||
                                            c.getItems().isWearingItem(33196) ||
                                            c.getItems().isWearingItem(33197) ||
                        ...
                        case SPECIAL:
                            ...
                            switch (npc.getNpcId()) {
                                ...
                                case 9400:
                                    ...
                                    c.gfx0(80);
                                    c.lastSpear = System.currentTimeMillis();
                                    c.getPA().getSpeared(npc.absX, npc.absY, 5);
                                    c.sendMessage("Ted makes you go flying backwards");
                                    break;
                                case 6610:
...
//                            applyDeflect(defender.asNPC(),defender.asPlayer(),damage);
                    ...
                    switch (npc.getNpcId()) {
                        ...
                        case 5890:
                            ...
                            break;
                        case 13201:
                            int health2 = npc.getHealth().getCurrentHealth();
                            c.guardianHits++;
                            int randomAmount2 = Misc.random(2);
                            switch (c.guardianHits) {
                                case 5:
                                case 10:
                                case 20:
                                case 30:
                                case 40:
                                    for (int id = 0; id < randomAmount2; id++) {
                                        int x = npc.absX + Misc.random(2);
                                        int y = npc.absY - Misc.random(2);
                                        NPCHandler.newNPC(1277, x, y, 0, 0, 30);
                                        c.sendMessage("@red@The Guardian Calls for help from the Forest!");
                                    }
                                    break;
                            ...
                            if (health2 < 400 && health2 > 329 || health2 < 100) {
                                npc.setAttackType(CombatType.RANGE);
                            }
                            if (health2 < 330 && health2 > 229) {
                                npc.setAttackType(CombatType.MAGE);
                            }
                            if (health2 < 230 && health2 > 99) {
                                for (int id = 0; id < randomAmount2; id++) {
                                    int x = npc.absX + Misc.random(2);
                                    int y = npc.absY - Misc.random(2);
                                    NPCHandler.newNPC(1277, x, y, 0, 0, 30);
                       ...
                       /* case 13201:
                            int health2 = npc.getHealth().getCurrentHealth();
                            int randomAmount2 = Misc.random(5);
                            if (health2 < 600 && health2 > 529 || health2 < 100) {
                                for (int id = 0; id < randomAmount2; id++) {
                                    int x = npc.absX + Misc.random(2);
                                    int y = npc.absY - Misc.random(2);
                                    NPCHandler.newNPC(1277, x, y, 0, 0, 15);
                                    c.sendMessage("@red@The Guardian Calls for help from the Forest!");
                                }
                                break;
                            }
                                ...
                                switch (npc.getAttackType()) {
                                    case MELEE:
                                        switch (Misc.random(1)) {
                                            case 0:
                                                npc.forceChat("TASTE MY SORCERESS PROWESS!");
                                                npc.setAttackType(CombatType.MAGE);
                                                break;
                                            case 1:
                                                npc.forceChat("NO DISTANCE WILL SAVE YOU!");
                                                npc.setAttackType(CombatType.MELEE);
                                                break;
                                        }
                                        break;
                                    ...
                                    case RANGE:
                                        switch (Misc.random(1)) {
                                            case 0:
                                                ...
                                                break;
                                            case 1:
                                                npc.forceChat("I WILL DESTROY YOU!");
                                                npc.setAttackType(CombatType.MELEE);
                                                break;
                                        }
                                        break;
