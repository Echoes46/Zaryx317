...
import io.zaryx.content.minigames.xeric.Xeric;
...
import static io.zaryx.model.entity.npc.NPCClipping.DIR;
...
public abstract class Entity {
    ...
    public double sapAttack = 10.0;
    public double sapStrength = 10.0;
    public double sapDefence = 10.0;
    public double sapRanged = 10.0;
    public double sapMagic = 10.0;

    public double leechAttack = 5.0;
    public double leechAttack_enemy = 10.0;

    public double leechRanged = 5.0;
    public double leechRanged_enemy = 10.0;
    public double leechMagic = 5.0;
    public double leechMagic_enemy = 10.0;
    public double leechDefence = 5.0;
    public double leechDefence_enemy = 10.0;
    public double leechStrength = 5.0;
    public double leechStrength_enemy = 10.0;
    ...
    public DungMain getDungInstance() {
        return dungInstance;
    }

    public Entity setDungInstance(DungMain dung) {
        this.dungInstance = dung;
        return this;
    }
