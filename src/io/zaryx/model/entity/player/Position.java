...
import io.zaryx.model.collisionmap.Tile;
...
public final class Position {
	...
	public boolean inWild() {
		if (Boundary.isIn(this, Boundary.Ferox1) ||
				...
				Boundary.isIn(this, Boundary.Ferox3)||
				Boundary.isIn(this, Boundary.Ferox4)||
				Boundary.isIn(this, Boundary.Ferox5)||
				Boundary.isIn(this, Boundary.Ferox6) ||
				Boundary.isIn(this, Boundary.WILDHOME1) ||
				Boundary.isIn(this, Boundary.WILDHOME2) ||
				Boundary.isIn(this, Boundary.DEEP_WILD_BANK) ||
				Boundary.isIn(this, Boundary.WILD_MINIGAME_AREA)) {
			return false;
		}
		if (inClanWars())
			return false;
		...
		if (Boundary.isIn(this, new Boundary(2094, 5966, 2095, 5967))) {
			return true;
		}
		if (Boundary.isIn(this, new Boundary(2096, 5967, 2098, 5968))) {
			return true;
		}
		if (Boundary.isIn(this, new Boundary(2098, 5966, 2099, 5967))) {
			return true;
		}
		if (Boundary.isIn(this, new Boundary(2090, 5968, 2091, 5969))) {
			return false;
		}
		if (Boundary.isIn(this, Boundary.BRYOPHYTA_ROOM)) {
			return false;
		}
		if (Boundary.isIn(this, Boundary.WILD_COX)) {
			return false;
		}
		if (Boundary.isIn(this, Boundary.WILD_TOB)) {
			return false;
		}
		if (Boundary.isIn(this, Boundary.WILD_ARBO)) {
			return false;
		}
		if (Boundary.isIn(this, Boundary.LOBBY)) {
			return false;
		}
		if (Boundary.isIn(this, Boundary.KRATOS_WILD)) {
			return true;
		}
		if (Boundary.isIn(this, Boundary.SAFE_ZONE_BLACK_KNIGHTS_FORTRESS)) {
			return false;
		}
		if (Boundary.isIn(this, new Boundary(3158, 4059, 3168, 4061)) || Boundary.isIn(this, new Boundary(3163, 4048, 3168, 4050))) {
			return false;
		}
		if (Boundary.isIn(this, Boundary.WILDYMAN_CAVE)) {
			return true;
		}
		if (Boundary.isIn(this, Boundary.WILDYMAN_MINING)) {
			return true;
		}
		if (Boundary.isIn(this, Boundary.WILDYAREA)) {
			return true;
		}
		if (Boundary.isIn(this, Boundary.WILDYAREAPATH)) {
			return true;
		}
		if (Boundary.isIn(this, Boundary.PERKWILD)) {
			return true;
		}
		if (Boundary.isIn(this, Boundary.WILDYAREA2)) {
			return true;
		}
		if (Boundary.isIn(this, Boundary.WILDERNESS_UNDERGROUND))
			return true;
		if (Boundary.isIn(this, Boundary.DEEP_WILD))
			return true;
	...
	@JsonIgnore
	public boolean inDungLobby() {//checks to see if player is in the raid lobby
		return Boundary.isIn(this, new Boundary(1772, 6447, 1790, 6461));
	}
	...
	@JsonIgnore
	public boolean inForestGuardian() {
		return x > 2254 && x < 2276 && y > 5006 && y < 5028;
	}
	...
	@JsonIgnore
	public boolean inHomeAreaSafe() {
		return x > 2090 && x < 2101 && y > 5955 && y < 5969;
	}
	...
	public boolean inMulti() {
		...
		if (Boundary.isIn(this, new Boundary(3222, 4070, 3252, 4101))) {
			return true;
		}

		if (Boundary.isIn(this, new Boundary(3082, 4052, 3106, 4071))) {
			return true;
		}

		if (Boundary.isIn(this, new Boundary(3132, 3994, 3203, 4057))) {
			return true;
		}

		if (Boundary.isIn(this, new Boundary(2646, 3699, 2723, 3733))) {
			return true;
		}
		...
		if (Boundary.isIn(this, Boundary.RELIC_GUARDIAN)) {
			return true;
		}
		...
		if (Boundary.isIn(this, new Boundary(2618, 3971, 2690, 3901))) {
			return true;
		}
		...
		if (Boundary.isIn(this, new Boundary(2253, 5006, 2278, 5029))) {
			return true;
		}
		...
		if (Boundary.isIn(this, Boundary.ZULRAH)
				...
				|| Boundary.isIn(this, Boundary.KRATOS_AREA)
