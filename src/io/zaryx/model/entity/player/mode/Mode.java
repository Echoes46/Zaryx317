...
public abstract class Mode {
	...
	private static final List<Mode> MODES = ImmutableList
			.copyOf(Arrays.asList(new RegularMode(ModeType.STANDARD),
					...
					new HardcoreWildyman(ModeType.GROUP_WILDYMAN),
	...
	public boolean is5x() {
		return type == ModeType.ROGUE || type == ModeType.ROGUE_HARDCORE_IRONMAN || type == ModeType.GROUP_WILDYMAN || type == ModeType.ROGUE_IRONMAN || type == ModeType.GROUP_IRONMAN;
	}
	...
	public boolean isWildyman() {
		return type == ModeType.WILDYMAN;
	}

	public boolean isGroupIronman() {
		return type == ModeType.GROUP_IRONMAN;
	}
	public boolean isGroupWildyman() {
		return type == ModeType.GROUP_WILDYMAN;
	}
