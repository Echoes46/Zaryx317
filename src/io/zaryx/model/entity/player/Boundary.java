...
public class Boundary {
	...
	public static final Boundary DONOSLAY = new Boundary(1856, 4992, 1919, 5055);
	...
	public static final Boundary RELIC_GUARDIAN = new Boundary(3009, 5768, 3029, 5797);
	public static final Boundary DUNG_LOBBY = new Boundary(1922, 6466, 1901, 6450);
	public static final Boundary WILDYMAN_CAVE = new Boundary(2364, 4217, 2435, 4296);

	public static final Boundary AFK_ZONE = new Boundary(1982, 5951, 2014, 6017);
	public static final Boundary AFK_ZONE_BOSS = new Boundary(2116, 5508, 2124, 5515);
	public static final Boundary KRATOS_WILD= new Boundary(3129, 5158, 3215, 5276);
	public static final Boundary KRATOS_AREA= new Boundary(3129, 5158, 3215, 5276);
	...
	public static final Boundary GROOT_BOSS = new Boundary(2491, 3902, 2561, 3969);
	...
	//public static final Boundary WILDYHOME = new Boundary(3387, 3789, 3481, 3823);
	//public static final Boundary WILDYHOME2 = new Boundary(3482, 3810, 3508, 3849);
	//public static final Boundary WILDYHOME3 = new Boundary(3402, 3853, 3480, 3890);
	public static final Boundary WILDYHOMECASTLE = new Boundary(3451, 3826, 3481, 3849);
	...
	public static final Boundary SCROLLCOLL = new Boundary(1805, 3088, 1845, 3128);
	public static final Boundary PERK_BOSS = new Boundary(3328, 9600, 3391, 9663,1);
	public static final Boundary WILD_SLAYERCAVE = new Boundary(3312, 10033, 3460, 10176);
...
//3082 3921
	...
	public static final Boundary HOME = new Boundary(3031, 3434, 3129, 3521);
	public static final Boundary WILDYMAN_MINING = new Boundary(3394, 3755, 3530, 3793);
	public static final Boundary WILDYAREAPATH = new Boundary(3393, 3782, 3412, 3844);
	/**
	 * mosleharmless cave
	 */
	...
	public static final Boundary SLAYER_REV_CAVE_4 = new Boundary(3314, 10038, 3458, 10170);
	...
	public static final Boundary HOMEHUNTER = new Boundary(2021, 5953, 2079, 6001);




	public static final Boundary RESOURCE_HUNTER = new Boundary(3174, 3925, 3202, 3944);
	public static final Boundary[] HUNTER_BOUNDARIES = {HUNTER_JUNGLE, HUNTER_WILDERNESS, HUNTER_LOVAK, HUNTER_DONATOR, HUNTER_LZ_DONATOR, RESOURCE_HUNTER, HOMEHUNTER};
	...
	public static final Boundary DONORV = new Boundary(2944, 5824, 3007, 5887);
	...
	public static final Boundary HOME_SAFE_PVP = new Boundary(2090, 5955, 2100, 5966);
	public static final Boundary DEEP_WILD = new Boundary(2884, 3971, 3317, 4158);
	public static final Boundary WILDHOME1 = new Boundary(3424, 3826, 3450, 3853);
	public static final Boundary WILDHOME2 = new Boundary(3448, 3825, 3482, 3850);
	public static final Boundary DEEP_WILD_BANK = new Boundary(3157, 4049, 3175, 4059);
	public static final Boundary WILD_MINIGAME_AREA = new Boundary(3142, 3728, 3152, 3738);


	public static final Boundary WILDYAREA = new Boundary(3410, 3792, 3469, 3823);

	public static final Boundary WILDYAREA2 = new Boundary(3407, 3847, 3496, 3891);
	public static final Boundary HOME_SAFE_PVP_2 = new Boundary(2090, 5967, 2094, 5968);
	public static final Boundary[] WILDERNESS_PARAMETERS = {WILDHOME1, WILDHOME2, WILDYAREA, WILDYAREA2, HOME_SAFE_PVP_2, HOME_SAFE_PVP, WILDERNESS, WILDERNESS_UNDERGROUND, WILDERNESS_GOD_WARS_BOUNDARY, REV_CAVE};
	...
	public static final Boundary HESPORI = new Boundary(3717, 4351, 3772, 4405);
	public static final Boundary HESPORI_EXIT = new Boundary(2093, 6002, 2097, 6006);
	public static final Boundary HESPORI_ENTRANCE = new Boundary(2093, 6002, 2097, 6006);
	...
	public static final Boundary DONATOR_ZONE_BLOODY = new Boundary(2027, 4516, 2046, 4543);
	...
	public static final Boundary ROCKCRAB= new Boundary(2643, 3700, 2696, 3746);
	public static final Boundary SANDCRAB= new Boundary(1695, 3453, 1813, 3490);


	public static final Boundary DZ250= new Boundary(2547, 3832, 2624, 3903);
	...
	public static final Boundary CURSEBEAST = new Boundary(3287, 3747, 3335, 3791);
	public static final Boundary WILDCURSEBEAST = new Boundary(3357, 3804, 3383, 3831);
	...
	//wildyman lobbies
	public static final Boundary WILD_COX = new Boundary(3179, 3721, 3185, 3728);
	public static final Boundary WILD_COXPARTY = new Boundary(3179, 3721, 3185, 3728);

	public static final Boundary WILD_TOB = new Boundary(3179, 3730, 3185, 3737);
	public static final Boundary WILD_TOBPARTY = new Boundary(3179, 3730, 3185, 3737);

	public static final Boundary WILD_ARBO = new Boundary(3179, 3739, 3185, 3746);
	public static final Boundary WILD_ARBOPARTY = new Boundary(3179, 3739, 3185, 3746);

	public static final Boundary PERKWILD = new Boundary(2698, 4559, 2749, 4608);
	 ...
	 * Dungeoneering
	 */
	public static final Boundary DUNG = new Boundary(1725, 6397, 1794, 6467);
	public static final Boundary DUNG_LOBBY_ENTRANCE = new Boundary(2378, 5961, 2417, 5997);
	...
	public static final Boundary MAIDEN = new Boundary(3160, 4435, 3187, 4458, 0);
	public static final Boundary BLOAT = new Boundary(3288, 4440, 3304, 4455, 0);
	public static final Boundary NYLO = new Boundary(3290, 4243, 3302, 4254, 0);
	public static final Boundary SOTE = new Boundary(3272, 4305, 3287, 4333, 0);
	public static final Boundary XARPUS = new Boundary(3163, 4380, 3177, 4395, 1);
	public static final Boundary[] TOBROOMS = {MAIDEN, BLOAT, NYLO, SOTE, XARPUS, TOB_VERZIK};
	...
	public static final Boundary OLM = new Boundary(3215, 5728, 3263, 5759);
	...
	public static final	Boundary PREMIUMBONFIRE = new Boundary(2407, 3819, 2415, 3826);



	public static final Boundary[] DUNGROOMS = {DUNG, };
	...
	public static final Boundary FULL_RAIDS = new Boundary(3204, 5118, 3379, 5766, 4);
	...
	public static final Boundary VARDORVIS = new Boundary(1123, 3412, 1135, 3424);
	...
	public static final Boundary ECTOFUNTUS = new Boundary(3647, 3511, 3670, 3529);
