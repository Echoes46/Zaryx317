...
import io.zaryx.content.skills.slayer.*;
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 793:
			...
			case 130135:
				...
				break;
			case 20377://switching to curses
				sendOption2("Curses", "Cancel");
				c.dialogueAction = 20377;
				break;
			case 62357://switching back to normal prayer
				sendOption2("Regular", "Cancel");
				c.dialogueAction = 62357;
				break;
		case 380:
			c.talkingNpc = 8761;
		...
		case 750:
			...
			if (c.getSlayer().getTask().isPresent()) {
				c.getDH().sendDialogues(3305, c.getSlayer().getMaster());
			} else {
