package io.zaryx.model.entity.player.save.impl;
...
public class TrouverParchmentPlayerSaveEntry implements PlayerSaveEntry {
    ...
    public void login(Player player) {
        ...
        if (items != null) {
            ...
            player.sendMessage("<img=1> @red@Trouver parchments have been removed, you've received {} Upgrade Points.", Misc.insertCommas(sum));
            player.sendMessage("<img=1> @red@If you have more, offer them to Nomad. Check the update log for more info.");
        }
    }
}
