...
import io.zaryx.content.achievement_diary.DifficultyAchievementDiary;
...
import io.zaryx.content.event.eventcalendar.EventChallengeKey;
import io.zaryx.content.lootbag.LootingBag;
import io.zaryx.content.lootbag.LootingBagItem;
import io.zaryx.content.minigames.barrows.brothers.Brother;
import io.zaryx.content.prestige.PrestigePerks;
import io.zaryx.content.privatemessaging.FriendType;
import io.zaryx.content.privatemessaging.FriendsListEntry;
...
import io.zaryx.content.skills.slayer.TaskExtension;
...
public class PlayerSave {
                ...
                if (spot > -1) {
                    ...
                    case 2: 
                        if (token.equals("character-height")) {
                            ...
                            for (String claim : claimedRaw) {
                                for (TeleportInterface.MONSTERS value : TeleportInterface.MONSTERS.values()) {
                                    if (value.name().equalsIgnoreCase(claim)) {
                                        ...
                                        if (monsters != null) {
                                            p.getFavoriteTeleports().add(monsters);
                                        }
                                    }
                                }
                                for (TeleportInterface.BOSSES value : TeleportInterface.BOSSES.values()) {
                                    if (value.name().equalsIgnoreCase(claim)) {
                                        ...
                                        if (bosses != null) {
                                            p.getFavoriteTeleports().add(bosses);
                                        }
                                    }
                                }
                                for (TeleportInterface.MINIGAMES value : TeleportInterface.MINIGAMES.values()) {
                                    if (value.name().equalsIgnoreCase(claim)) {
                                        ...
                                        if (minigames != null) {
                                            p.getFavoriteTeleports().add(minigames);
                                        }
                                    }
                                }
                                for (TeleportInterface.DUNGEONS value : TeleportInterface.DUNGEONS.values()) {
                                    if (value.name().equalsIgnoreCase(claim)) {
                                        ...
                                        if (dungeons != null) {
                                            p.getFavoriteTeleports().add(dungeons);
                                        }
                                    }
                                }
                                for (TeleportInterface.SKILLING value : TeleportInterface.SKILLING.values()) {
                                    if (value.name().equalsIgnoreCase(claim)) {
                                        ...
                                        if (skilling != null) {
                                            p.getFavoriteTeleports().add(skilling);
                                        }
                                    }
                                }
                            ...
                            p.setTeleportToX((Integer.parseInt(token2) == -1 ? Configuration.START_LOCATION_X : Integer.parseInt(token2)));
                        } else if (token.equals("character-posy")) {
                            p.setTeleportToY((Integer.parseInt(token2) == -1 ? Configuration.START_LOCATION_Y : Integer.parseInt(token2)));
                        ...
                        } else if (token.equals("yakplaytime")) {
                            p.yakplayTime = Integer.parseInt(token2);
                        } else if (token.equals("yaklevel")) {
                            p.yakLevel = Integer.parseInt(token2);
                        } else if (token.equals("packyakslots")) {
                            p.packyakSlots = Integer.parseInt(token2);
                        } else if (token.equals("experience-counter")) {
                            p.setExperienceCounter(Long.parseLong(token2));
                        } else if (token.equals("startedFaction")) {
                            p.startedFaction = Boolean.parseBoolean(token2);
                        } else if (token.equals("saradominFaction")) {
                            p.saradominFaction = Boolean.parseBoolean(token2);
                        } else if (token.equals("zamorakFaction")) {
                            p.zamorakFaction = Boolean.parseBoolean(token2);
                        } else if (token.equals("guthixFaction")) {
                            p.guthixFaction = Boolean.parseBoolean(token2);
                        } else if (token.equals("collectorNecklace")) {
                            p.collectNecklace = Boolean.parseBoolean(token2);
                        }  else if (token.equals("nexUnlocked")) {
                            p.NexUnlocked = Boolean.parseBoolean(token2);
                        }  else if (token.equals("ragePotion")) {
                            p.usingRage = Boolean.parseBoolean(token2);
                        }  else if (token.equals("hweenUnlocked")) {
                            p.halloweenGlobal = Boolean.parseBoolean(token2);
                        } else if(token.equals("comp-cape-colours")) {
                            int[] colours = new int[4];
                            for (int i = 0; i < colours.length; i++) {
                                colours[i] = Integer.parseInt(token3[i]);
                            }
                            p.getCompletionistCapeRe().setColours(colours[0], colours[1], colours[2], colours[3]);
                        ...
                        } else if (token.equals("show-clepto-warning")) {
                            p.setCleptoWarning(Boolean.parseBoolean(token2));
                        ...
                        } else if (token.equals("scroll-table")) {
                            p.twoHourClaimable = Boolean.parseBoolean(token2);
                            ...
                            p.InfAgroTimer = Long.parseLong(token2);
                        } else if (token.equals("ragepot")) {
                            p.RageTimer = Long.parseLong(token2);
                            ...
                            p.arboCompletions = (Integer.parseInt(token2));
                            ...
                            p.hasAchieveFix = Boolean.parseBoolean(token2);
                            ...
                            p.candyTimer = Long.parseLong(token2);
                        ...
                        } else if (token.equals("joinedWildymanGroup")) {
                            p.setJoinedWildymanGroup(Boolean.parseBoolean(token2));
                        ...
                        } else if (token.equals("freerank")) {
                            p.freeranks = Boolean.parseBoolean(token2);
                        } else if (token.equals("maxAttack")) {
                            p.maxAttack = Boolean.parseBoolean(token2);
                        } else if (token.equals("maxStrength")) {
                            p.maxStrength = Boolean.parseBoolean(token2);
                        } else if (token.equals("maxDefense")) {
                            p.maxDefense = Boolean.parseBoolean(token2);
                        } else if (token.equals("maxRange")) {
                            p.maxRange = Boolean.parseBoolean(token2);
                        } else if (token.equals("maxHealth")) {
                            p.maxHealth = Boolean.parseBoolean(token2);
                        } else if (token.equals("maxMage")) {
                            p.maxMage = Boolean.parseBoolean(token2);
                        } else if (token.equals("maxPrayer")) {
                            p.maxPrayer = Boolean.parseBoolean(token2);
                        } else if (token.equals("BonusDmg")) {
                            p.bonusDmg = Boolean.parseBoolean(token2);
                        } else if (token.equals("BonusDmgTime")) {
                            p.bonusDmgTicks = Long.parseLong(token2);
                        ...
                        } else if (token.equals("armadyl-staff-charge")) {
                            p.setArmadylStaffCharge(Integer.parseInt(token2));
                            ...
                            p.setAfkTier(Integer.parseInt(token2));
                        } else if (token.equals("afkAttempts")) {
                            p.setAfkAttempts(Integer.parseInt(token2));
                            ...
                            p.WGPoints = Integer.parseInt(token2);
                        } else if (token.equals("wgWin")) {
                            p.WGWins = Integer.parseInt(token2);
                            ...
                            p.dailyDamage = Long.parseLong(token2);
                        }  else if (token.equals("daily2xraid")) {
                            p.daily2xRaidLoot = Long.parseLong(token2);
                        }  else if (token.equals("daily2x")) {
                            p.daily2xXPGain = Long.parseLong(token2);
                        }  else if (token.equals("dailyddr")) {
                            p.doubleDropRate = Long.parseLong(token2);
                        }  else if (token.equals("dailyAgro")) {
                            p.weeklyInfAgro = Long.parseLong(token2);
                        }  else if (token.equals("dailyPray")) {
                            p.weeklyInfPot = Long.parseLong(token2);
                        }  else if (token.equals("dailyOverload")) {
                            p.weeklyOverload = Long.parseLong(token2);
                        }  else if (token.equals("dailyRage")) {
                            p.weeklyRage = Long.parseLong(token2);
                        }  else if (token.equals("eliteboost")) {
                            p.EliteCentBoost = Long.parseLong(token2);
                        }  else if (token.equals("eliteboostc")) {
                            p.EliteCentCooldown = Long.parseLong(token2);
                        }  else if (token.equals("cent")) {
                            p.centurion = Integer.parseInt(token2);
                        }  else if (token.equals("cosC")) {
                            p.setCosmeticCredits(Long.parseLong(token2));
                        } else if (token.equals("arboPoints")) {
                            p.arboPoints = Long.parseLong(token2);
                        } else if (token.equals("afk")) {
                            p.setAfkPoints(Integer.parseInt(token2));
                        } else if (token.equals("trivia")) {
                            p.setTriviaPoints(Integer.parseInt(token2));
                        } else if (token.equals("bloodyp")) {
                            p.setBloody_points(Integer.parseInt(token2));
                        } else if (token.equals("seasonal")) {
                            p.setSeasonalPoints(Integer.parseInt(token2));
                        } else if (token.equals("foundry")) {
                            p.foundryPoints = Long.parseLong(token2);
                        }  else if (token.equals("blastcoffer")) {
                            p.getBlastFurnace().getCoffer().depositToCoffer(Integer.parseInt(token2));
                            ...
                            p.setDonorBossKC(Integer.parseInt(token2));
                        } else if (token.equals("donobosstime")) {
                            p.setDonorBossDate(LocalDate.parse(token2));
                        } else if (token.equals("donobosskcx")) {
                            p.setDonorBossKCx(Integer.parseInt(token2));
                        } else if (token.equals("donobosstimex")) {
                            p.setDonorBossDatex(LocalDate.parse(token2));
                        } else if (token.equals("donobosskcy")) {
                            p.setDonorBossKCy(Integer.parseInt(token2));
                        } else if (token.equals("donobosstimey")) {
                            p.setDonorBossDatey(LocalDate.parse(token2));
                        } else if (token.equals("prestige-points")) {
                            p.prestigePoints = Integer.parseInt(token2);
                        }  else if (token.equals("division-tier")) {
                            p.setTier(Integer.parseInt(token2));
                        }  else if (token.equals("division-xp")) {
                            p.setXp(Integer.parseInt(token2));
                        }  else if (token.equals("division-member")) {
                            p.setMember(Boolean.parseBoolean(token2));
                        }  else if (token.equals("division-season")) {
                            p.setCurrentSeason(Integer.parseInt(token2));
                            ...
                            p.instanceCurrency = Long.parseLong(token2);
                            ...
                            p.SafetyTimer = Long.parseLong(token2);
                        } else if (token.equals("island-end")) {
                            p.IslandTimer = Long.parseLong(token2);
                        } else if (token.equals("coll-end")) {
                            p.CollTimer = Long.parseLong(token2);
                            ...
                            p.setQuestPoints(Integer.parseInt(token2));
                            ...
                            p.hideDonor = Boolean.parseBoolean(token2);
                            ...
                            p.getChristmasWeapons().setBowCharges(Integer.parseInt(token2));
                        } else if (token.equals("scytheCharge")) {
                            p.getChristmasWeapons().setScytheCharges(Integer.parseInt(token2));
                        } else if (token.equals("whipCharge")) {
                            p.getChristmasWeapons().setWhipCharges(Integer.parseInt(token2));
                        } else if (token.equals("presentCounter")) {
                            p.setPresentCounter(Integer.parseInt(token2));
                        }
                        ...
                        case 67:
                            if (token.equals("character-cosmetic")) {
                                p.playerEquipmentCosmetic[Integer.parseInt(token3[0])] = Integer.parseInt(token3[1]);
                            }
                            break;
                        case 68:
                            if (token.equals("character-cosmetic-boolean")) {
                                p.cosmeticOverrides[Integer.parseInt(token3[0])] = Boolean.parseBoolean(token3[1]);
                            }
                            break;
                    case 4: 
                    ...
                    case 5: 
                        ...
                        case 61:
                            if (token.equals("perk-item")) {
                                p.getPerkSytem().gameItems.add(new GameItem(Integer.parseInt(token3[1]), Integer.parseInt(token3[2])));
                            }
                            break;
                        case 63:
                            if (token.equals("disolve-item")) {
                                p.getRecentlyDissolvedItems().add(Integer.parseInt(token3[1]));
                                p.getRecentlyDissolvedPrices().add(Long.parseLong(token3[2]));
                            }
                            break;
                        case 64:
                            if (token.equals("prestige-perk")) {
                                PrestigePerks.handleLoading(p, PrestigePerks.values()[Integer.parseInt(token3[2])]);
                            }
                            break;
                        case 65:
                            if (token.equals("scrollboost")) {
                                for (BoostScrolls value : BoostScrolls.values()) {
                                    if (value.name().equalsIgnoreCase(token3[0])) {
                                        p.boostTimers.put(value, Long.parseLong(token3[1]));
                                    }
                                }
                            }
                            break;
                            ...
                            if (token.equals("gift-item")) {
                                for (Christmas.Gifts value : Christmas.Gifts.values()) {
                                    if (value.name().equalsIgnoreCase(token3[1])) {
                                        p.christmasGifts.add(value);
                                    }
                                }
                            }
                            break;
                        case 88:
                            if (token.equals("yakbag")) {
                                int id = Integer.parseInt(token3[1]);
                                int amt = Integer.parseInt(token3[2]);
                                p.pakyakitems.add(new LootingBagItem(id, amt));
                            }
                            break;
                    case 46: 
                    ...
                    case 57: 
                        ...
                        case 60:
                            if (token.equals("death-storage")) {
                                int id = Integer.parseInt(token3[1]);
                                int amt = Integer.parseInt(token3[2]);
                                p.getDeathStorage().add(new GameItem(id, amt));
                            }
                            break;
                        case 62:
    ...
    public static boolean saveGameInstant(Player p) {
        ...
        try {
            ...
            characterfile.newLine();
            characterfile.write("packyakslots = " + p.packyakSlots);
            characterfile.newLine();
            characterfile.write("yaklevel = " + p.yakLevel);
            characterfile.newLine();
            characterfile.write("yakplaytime = " + p.yakplayTime);
            characterfile.newLine();
            characterfile.write("revert-option = " + p.getRevertOption());
            characterfile.newLine();
            characterfile.write("dropBoostStart = " + p.dropBoostStart);
            characterfile.newLine();
            characterfile.write("startedFaction = " + p.startedFaction);
            characterfile.newLine();
            characterfile.write("saradominFaction = " + p.saradominFaction);
            characterfile.newLine();
            characterfile.write("zamorakFaction = " + p.zamorakFaction);
            characterfile.newLine();
            characterfile.write("guthixFaction = " + p.guthixFaction);
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("armadyl-staff-charge = " + p.getArmadylStaffCharge());
            characterfile.newLine();

            characterfile.write("bryophyta-charge = " + p.bryophytaStaffCharges);
            characterfile.newLine();
            characterfile.write("questPoints = " + p.getQuestPoints());
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("freerank = ", 0, 11);
            characterfile.write(Boolean.toString(p.freeranks), 0, Boolean.toString(p.freeranks).length());
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("triviaP = ", 0, 10);
            characterfile.write(Integer.toString(p.getTriviaPoints()), 0, Integer.toString(p.getTriviaPoints()).length());
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("loyalty-reward = " + p.loyaltyChestClaimable);
            characterfile.newLine();
            characterfile.write("scroll-table = " + p.twoHourClaimable);
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("coll-end = ", 0, 11);
            characterfile.write(Long.toString(p.CollTimer), 0, Long.toString(p.CollTimer).length());
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("joinedWildymanGroup = ");
            characterfile.write(p.isJoinedWildymanGroup() + "");
            characterfile.newLine();
            ...
            characterfile.write("[YAKBAG]");
            characterfile.newLine();
            for (int i = 0; i < p.pakyakitems.size(); i++) {
                if (p.pakyakitems.get(i).getId() > 0) {
                    characterfile.write("yakbag = ", 0, 9);
                    characterfile.write(Integer.toString(i), 0, Integer.toString(i).length());
                    characterfile.write("\t", 0, 1);
                    int id = p.pakyakitems.get(i).getId();
                    int amt = p.pakyakitems.get(i).getAmount();
                    characterfile.write(Integer.toString(id), 0, Integer.toString(id).length());
                    characterfile.write("\t", 0, 1);
                    characterfile.write(Integer.toString(amt), 0, Integer.toString(amt).length());
                    characterfile.newLine();
