...
import io.zaryx.content.dialogue.impl.AmethystChiselDialogue;
...
public class ItemOptionThree implements PacketType {
    ...
    public void processPacket(Player c, int packetType, int packetSize) {
        ...
        if (c.getItems().hasItemOnOrInventory(26314)) {
...
//        if (Thammaron.clickItem(c, itemId, 3)) {
//            return;
//        }
        ...
        switch (itemId) {
            ...
            case 12924:
                ...
                break;
            case 12579:
                new ArboBox(c).quickOpen();
                break;
            case 12582:
                new CoxBox(c).quickOpen();
                break;
            case 12588:
                new DonoBox(c).quickOpen();
                break;
            case 19891:
                new TobBox(c).quickOpen();
                break;
            case 19897:
                new CosmeticBox(c).quickOpen();
                break;
            case 6680:
                new MiniArboBox(c).quickOpen();
                break;
            case 12585:
                new MiniCoxBox(c).quickOpen();
                break;
            case 19887:
                new MiniDonoBox(c).quickOpen();
                break;
            case 22087:
                new DragonToken(c).quickOpen();
                break;
            case 6679:
                new MiniNormalMysteryBox(c).quickOpen();
                break;
            case 6677:
                new MiniSmb(c).quickOpen();
                break;
            case 19895:
                new MiniTobBox(c).quickOpen();
                break;
            case 6678:
                new MiniUltraBox(c).quickOpen();
                break;
            case 13346:
                new UltraMysteryBox(c).quickOpen();
                break;
            case 6829:
                new p2pDivisionBox(c).quickOpen();
                break;
            case 6831:
                new f2pDivisionBox(c).quickOpen();
                break;
            case 6199:
