			...
			switch (itemId) {
				case 12608:
					if (System.currentTimeMillis() - c.lastPerformedEmote < 2500)  {
						...
						c.forcedChat("If you not worthy of Big High War God... you get made dead soon.");
					}
					break;
				case 12610:
					if (System.currentTimeMillis() - c.lastPerformedEmote < 2500)  {
						...
						c.startAnimation(1670);
						c.forcedChat("Peace shall bring thee wisdom; Wisdom shall bring thee peace. This is the law of Armadyl.");
					}
					break;
				case 12612:
					if (System.currentTimeMillis() - c.lastPerformedEmote < 2500)  {
						...
						c.startAnimation(1670);
						c.forcedChat("One day your loyalty will be rewarded. Power to the Great Lord!");
					}
					break;
				case 3842:
					if (System.currentTimeMillis() - c.lastPerformedEmote < 2500)  {
						...
						c.startAnimation(1670);
						c.forcedChat("Battle is by those who choose to disagree with it. Zamorak give me strength!");
					}
					break;
				case 3840:
					if (System.currentTimeMillis() - c.lastPerformedEmote < 2500)  {
						...
						c.startAnimation(1670);
						c.forcedChat("The currency of goodness is honour; It retains its value through scarcity. This is Saradomin's wisdom");
					}
					break;
				case 3844:
					if (System.currentTimeMillis() - c.lastPerformedEmote < 2500)  {
						...
						c.startAnimation(1670);
						c.forcedChat("The trees, the earth, the sky, the waters; All play their part upon this land. May Guthix bring you balance.");
					}
					break;
...
//				Thammaron.checkChargesRemaining(c);
//				break;
				case 84:
					Armadyl.checkChargesRemaining(c);
					break;
			case 2550:
			...
			case 12904:
				...
				break;
				case 28585:
					c.sendMessage("The Warped Sceptre has " + c.getToxicStaffOfTheDeadCharge() + " charges remaining.");
					break;
...
//                TeleportInterface.sendMonsterTab(player);
			...
			case 20243:
				...
				if (c.collectCoins == true) {
					...
					c.sendMessage("@blu@You have now @red@Disabled@blu@ collecting");
			} else if (c.collectCoins == false) {
					c.collectCoins = true;
					c.sendMessage("@blu@You have now @gre@Enabled@blu@ collecting.");
			}
			break;
			case 4212:
			case 4214:
			...
			case 4223:
				...
				case 26314:
					if(c.wildLevel < 100) {
						c.getPA().startTeleport(2095, 6003, 0, "pod", true);
					}
					break;
			...
			case 9763:
				...
				case 11978:
					...
					if (c.wildLevel > 30 && c.petSummonId != 10533) {
					...
					switch (slot) {
						case 1:
							...
							if (c.getItems().playerHasItem(11978, 1)) {
								c.getItems().deleteItem(11978, 1);
								c.getItems().addItem(11976, 1);
								c.getPA().startTeleport(3088, 3493, 0, "glory",false);
								c.sendMessage("@red@You now have 5 charges left in your glory.");

							} else if (c.getItems().playerHasItem(11976, 1)) {
								c.getItems().deleteItem(11976, 1);
								c.getItems().addItem(1712, 1);
								c.getPA().startTeleport(3088, 3493, 0, "glory",false);
								c.sendMessage("@red@You now have 4 charges left in your glory.");

							} else if (c.playerEquipment[Player.playerAmulet] == 1712) { // new
						...
						case 2:
							...
							if (c.getItems().playerHasItem(11978, 1)) {
								...
								c.getDiaryManager().getKaramjaDiary().progress(KaramjaDiaryEntry.TELEPORT_TO_KARAMJA);							c.sendMessage("@red@You now have 5 charges left in your glory.");
								c.sendMessage("@red@You now have 5 charges left in your glory.");
							} else if (c.getItems().playerHasItem(11976, 1)) {
								c.getItems().deleteItem(11976, 1);
								c.getItems().addItem(1712, 1);
								c.getPA().startTeleport(2925, 3173, 0, "glory",false);
								c.getDiaryManager().getKaramjaDiary().progress(KaramjaDiaryEntry.TELEPORT_TO_KARAMJA);							c.sendMessage("@red@You now have 4 charges left in your glory.");
								c.sendMessage("@red@You now have 4 charges left in your glory.");
							} else if (c.playerEquipment[Player.playerAmulet] == 1712) { // new
								c.getItems().equipItem(1710, 1, 2);
								c.setAppearanceUpdateRequired(true);
