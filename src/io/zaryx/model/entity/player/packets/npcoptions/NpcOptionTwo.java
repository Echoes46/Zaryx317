...
import io.zaryx.content.dialogue.impl.IronmanNpcDialogue;
...
//			}
		...
		case DailyRewardsDialogue.DAILY_REWARDS_NPC:
			...
			break;
			case 3005:
				player.getPA().startTeleport(3659, 3526, 0, "modern", false);
				break;
			case 10529:
				//player.sendMessage("Dude im disabled");
				player.sendMessage("@bla@You currently have @red@"+player.foundryPoints+"@bla@ Upgrade Points.");
