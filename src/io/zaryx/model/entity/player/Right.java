...
public enum Right implements Comparator<Right> {
	...
	public static final EnumSet[] DISPLAY_GROUPS = {
			...
			EnumSet.of(HITBOX, EVENT_MAN, IRONMAN, ULTIMATE_IRONMAN, OSRS,OSRS_IRONMAN, MEMBERSHIP, HC_IRONMAN, ROGUE,
					ROGUE_HARDCORE_IRONMAN, ROGUE_IRONMAN, GROUP_IRONMAN, WILDYMAN, GROUP_WILDYMAN),
			EnumSet.of(FACTION_G, FACTION_S, FACTION_Z)
	 ...
	 * </p>
	 */
	public static final Right[] PRIORITY = { PLAYER, WILDYMAN, GROUP_WILDYMAN, OSRS, OSRS_IRONMAN, EVENT_MAN, HC_IRONMAN, GROUP_IRONMAN, IRONMAN, ULTIMATE_IRONMAN,
			...
			GAME_DEVELOPER, MODERATOR, ADMINISTRATOR, COMMUNITY_MANAGER, STAFF_MANAGER, UNKNOWN, FACTION_G, FACTION_S, FACTION_Z};
	...
	public Mode getMode() {
		switch (this) {
			...
			case GROUP_WILDYMAN:
				return Mode.forType(ModeType.GROUP_WILDYMAN);
		}
