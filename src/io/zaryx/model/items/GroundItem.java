...
public class GroundItem {
	...
	public boolean isViewable(Player player) {
		...
		return isOwner(player) || isGroupIronman && checkForGroupMember(player, getOwnerName()) || !ironman && isGlobal() || isGroupWildyman && checkforWildyGroupMember(player, getOwnerName());
	}
	...
	public boolean checkforWildyGroupMember(Player player, String dropOwner) {
		if (dropOwner == null)
			return false;
