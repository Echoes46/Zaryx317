package io.zaryx.model.definitions;
...
import io.zaryx.model.items.EquipmentModelType;
...
public class ItemDef {
    ...
    public static ItemDef forId1(int[] itemId) {
        Preconditions.checkState(definitions != null, "Item definitions weren\'t loaded.");
        return definitions.getOrDefault(itemId, builder().id1(itemId).build());
    }
    ...
    public static class ItemDefBuilder {
        ...
        public ItemDef.ItemDefBuilder id1(final int[] id) {
            this.id1 = id;
            return this;
        }
