...
public class DiscordIntegration {
    ...
    /**
     * Generate a safe, alphanumeric, uppercase code.
    ...
    /**
     * Normalize user-entered code.
     * Strips non-alphanumeric characters and uppercases the result.
     */
    ...
    public static void sendPMS(String content) {
        ...
        for (Map.Entry<String, Long> entry : connectedAccounts.entrySet()) {
            ...
            user.openPrivateChannel().queue(pc -> {
                ...
                pc.sendMessage(content).queue(null, handler);
            });
        }
    }
    ...
    public static void integrateAccount(Player player, String code) {
        ...
        if (connectedAccounts.containsValue(userId)
                && !Objects.equals(connectedAccounts.get(player.getLoginName()), userId)) {
        ...
        Discord.writeServerSyncMessage(
    ...
    public static void loadConnectedAccounts() {
        ...
        File file = new File(DISCORD_SAVE_PATH);
        ...
        try {
            ...
            if (!file.exists()) {
                ...
                saveConnectedAccounts();
                System.out.println("Created new Discord Connected Accounts file.");
                return;
            }
            ...
            if (file.length() == 0) {
                ...
                disableMessage = new ArrayList<>();
                saveConnectedAccounts();
                System.out.println("Discord Connected Accounts file was empty. Resetting file.");
                return;
            }
            ...
            try (FileReader fileReader = new FileReader(file)) {
                ...
                if (reader.has("connectedAccounts") && !reader.get("connectedAccounts").isJsonNull()) {
                ...
                if (reader.has("disableMessage") && !reader.get("disableMessage").isJsonNull()) {
                    Long[] data = gson.fromJson(reader.get("disableMessage"), Long[].class);
    ...
    public static void saveConnectedAccounts() {
        ...
        try {
            ...
            object.add("connectedAccounts", gson.toJsonTree(
                    connectedAccounts != null ? connectedAccounts : new HashMap<>()
            ));

            object.add("disableMessage", gson.toJsonTree(
                    disableMessage != null ? disableMessage : new ArrayList<>()
            ));
    ...
    public static void syncUser(Player player) {
        ...
        player.getPA().sendEnterString(
                "Enter the code from the Discord Bot.",
                DiscordIntegration::integrateAccount
        );
    }
    ...
    public static void givePoints() {
        ...
        for (Map.Entry<String, Long> entry : connectedAccounts.entrySet()) {
            ...
            for (Activity activity : member.getActivities()) {
                String statusName = activity.getName();
