...
import io.zaryx.content.items.item_combinations.ArcaneSpiritShield;
import io.zaryx.content.items.item_combinations.BalanceBook;
import io.zaryx.content.items.item_combinations.BlessedSpiritShield;
import io.zaryx.content.items.item_combinations.ElysianSpiritShield;
import io.zaryx.content.items.item_combinations.EternalBoots;
import io.zaryx.content.items.item_combinations.HolyBook;
import io.zaryx.content.items.item_combinations.InfernalAxe;
import io.zaryx.content.items.item_combinations.InfernalPickaxe;
import io.zaryx.content.items.item_combinations.PegasianBoots;
import io.zaryx.content.items.item_combinations.PrimordialBoots;
import io.zaryx.content.items.item_combinations.RingOfWealthImbued;
import io.zaryx.content.items.item_combinations.SaradominsBlessedSword;
import io.zaryx.content.items.item_combinations.SpectralSpiritShield;
import io.zaryx.content.items.item_combinations.TentacleWhip;
import io.zaryx.content.items.item_combinations.UnholyBook;
import io.zaryx.content.items.item_combinations.InfernalHarpoon;
import io.zaryx.model.items.GameItem;
import io.zaryx.model.items.ItemCombination;
