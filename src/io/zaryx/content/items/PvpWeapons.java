...
public class PvpWeapons {
    ...
    private static final int[] PVP_WEAPONS = {
            Items.CRAWS_BOW, Items.THAMMARONS_SCEPTRE, Items.VIGGORAS_CHAINMACE, Items.ACCURSED,
    };
    ...
    private static final int[] U_PVP_WEAPONS = {Items.CRAWS_BOW_U, Items.THAMMARONS_SCEPTRE_U,
            Items.VIGGORAS_CHAINMACE_U,  Items.ACCURSED_U};
     ...
     */
    public int viggoraChainmaceCharges;
    /**
     * The amount of charges the player has for Thammaron's Sceptre
     */
    public int thammaronSceptreCharges;
    /**
    ...
    public PvpWeapons(Player player) {
        this.player = player;
        this.viggoraChainmaceCharges = 16000;
        this.thammaronSceptreCharges = 16000;
        this.crawsBowCharges = 16000;
    }
    ...
    public static void giveStartingCharges(Player player) {
        player.getPvpWeapons().setCrawsBowCharges(16000);
        player.getPvpWeapons().setViggoraChainmaceCharges(16000);
        player.getPvpWeapons().setThammaronSceptreCharges(16000);
    }
    ...
    public static void degradeWeaponAfterCombat(Player player, boolean usingMagic) {
        ...
        if (weaponId ==  Items.ACCURSED && !usingMagic) return;
