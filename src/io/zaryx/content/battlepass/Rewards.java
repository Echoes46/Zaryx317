...
public class Rewards {
    ...
    public static void generateRewards() {
        ...
        defaultRewards.set(4, new GameItem(6831, 2));//5
        defaultRewards.set(19, new GameItem(6831, 2));//20
        defaultRewards.set(39, new GameItem(6831, 2));//40
        defaultRewards.set(49, new GameItem(6829, 1));//50

        memberRewards.set(4, new GameItem(6829, 2));//5
        memberRewards.set(14, new GameItem(696, 80));//15
        memberRewards.set(19, new GameItem(6829, 2));//20
        memberRewards.set(34, new GameItem(696, 80));//35
        memberRewards.set(39, new GameItem(6829, 2));//40
        memberRewards.set(46, new GameItem(696, 80));//47
        memberRewards.set(47, new GameItem(696, 80));//48
        memberRewards.set(48, new GameItem(696, 80));//49
