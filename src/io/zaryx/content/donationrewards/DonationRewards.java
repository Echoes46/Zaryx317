package io.zaryx.content.donationrewards;
...
import io.zaryx.util.SundayReset;
    ...
    public void increaseDonationAmount(int amount) {
        if (amount > 0) {
            ...
            if (amountDonatedThisWeek >= 500) {
                ...
                player.sendErrorMessage("Due to your support your weekly donation has been reset earlier!");
            }
        }
    }
