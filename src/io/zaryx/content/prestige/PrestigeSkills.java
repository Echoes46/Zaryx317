...
public class PrestigeSkills {
	...
	public void prestige() {
		...
		if (player.maxRequirements(player)) { // If the skill is 99
			...
			if (player.prestigeLevel[0] == 0) {
				player.getItems().addItemUnderAnyCircumstance(30303, 1);
			}
			if (player.prestigeLevel[0] == 1) {
				player.getItems().addItemUnderAnyCircumstance(30304, 1);
			}
			if (player.prestigeLevel[0] == 2) {
				player.getItems().addItemUnderAnyCircumstance(30305, 1);
			}
			if (player.prestigeLevel[0] == 3) {
				player.getItems().addItemUnderAnyCircumstance(30306, 1);
			}
			if (player.prestigeLevel[0] == 4) {
				player.getItems().addItemUnderAnyCircumstance(30307, 1);
			}
			if (player.prestigeLevel[0] == 5) {
				player.getItems().addItemUnderAnyCircumstance(30308, 1);
			}
