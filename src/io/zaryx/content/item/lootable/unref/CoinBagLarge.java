package io.zaryx.content.item.lootable.unref;
...
public class CoinBagLarge extends CycleEvent {
	...
	public void openall() {
		...
		int coins = 100000 + Misc.random(400000);
		int coinsDouble = 100000 + Misc.random(500000);
	...
	public void execute(CycleEventContainer container) {
		...
		int coins = 5000 + Misc.random(20000);
		int coinsDouble = 1;
		int random = Misc.random(100);
		List<GameItem> itemList = random < 55 ? items.get(Rarity.COMMON) : random >= 55 && random <= 80 ? items.get(Rarity.UNCOMMON) : items.get(Rarity.RARE);
		GameItem item = Misc.getRandomItem(itemList);
