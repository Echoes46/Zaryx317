	...
	static {
		items.put(LootRarity.COMMON,
			Arrays.asList(
					new GameItem(26882),
					new GameItem(26882),
					new GameItem(21547),  //small foe bone
					new GameItem(21547),  //small foe bone
					new GameItem(21547),  //small foe bone
					new GameItem(21547),  //small foe bone
					new GameItem(21549),  //medium foe bone
					new GameItem(21549),  //medium foe bone
					new GameItem(21549),  //medium foe bone
					new GameItem(21551),  //large foe bone
					new GameItem(21551),  //large foe bone
					new GameItem(21553),  //rare foe bone
		...
		items.put(LootRarity.UNCOMMON,
			...
			items.put(LootRarity.RARE,
					Arrays.asList(
							new GameItem(26883),
							new GameItem(TheUnbearable.KEY),    //unbearable key
							new GameItem(FragmentOfSeren.KEY),  //serens key
							...
							new GameItem(11212, 100), //Dragon arrows
							new GameItem(11212, 100), //Dragon arrows
