package io.zaryx.content.skills.runecrafting;
...
public class Runecrafting extends SkillHandler {
	...
	public enum RunecraftingData {
		AIR(25378, 556, 10, new int[] { 1, 11, 22, 33, 44, 55, 66, 77, 88, 99 }, 2500, 20667),
		MIND(25379, 558, 11, new int[] { 2, 14, 28, 42, 56, 70, 84, 98 }, 2500, 20669),
		WATER(25376, 555, 12, new int[] { 5, 19, 38, 57, 76, 88, 99 }, 2500, 20671),
		MIST(-1, -1, 15, new int[] { 6 }, 2500, -1),
		EARTH(24972, 557, 13, new int[] { 9, 26, 52, 78, 88, 96 }, 2500, 20673),
		DUST(-1, -1, 16.6, new int[] { 10 }, 2500, -1),
		MUD(-1, -1, 18.6, new int[] { 13 }, 2500, -1),
		FIRE(24971, 554, 14, new int[] { 14, 35, 70, 85, 95 }, 2500, 20665),
		SMOKE(-1, -1, 17, new int[] { 15 }, 2500, -1),
		STEAM(-1, -1, 18.6, new int[] { 19 }, 2500, -1),
		BODY(24973, 559, 15, new int[] { 20, 46, 75, 92 }, 2500, 20675),
		LAVA(-1, -1, 20, new int[] { 23 }, 2500, -1),
		COSMIC(24974, 564, 16, new int[] { 27, 59, 78 }, 2500, 20677),
		CHAOS(24976, 562, 17, new int[] { 35, 74, 86 }, 2500, 20679),
		ASTRAL(14911, 9075, 17.4, new int[] { 40, 82 }, 2500, 20689),
		NATURE(24975, 561, 18, new int[] { 44, 91, 95 }, 2500, 20681),
		LAW(25034, 563, 19, new int[] { 54, 79, 93 }, 2500, 20683),
		DEATH(25035, 560, 30, new int[] { 65, 84, 96 }, 2500, 20685),
		BLOOD(43848, 565, 51, new int[] { 77, 89, 94 }, 2500, 20691),
		WRATH(34772, 21880, 58, new int[] { 95 }, 2500, 20691),
		SOUL(25377, 566, 36, new int[] { 90, 95, 99 }, 2500, 20687),
		DEATH_DZ(43707, 560, 30, new int[] { 65, 84, 96 }, 2500, 20685),
		BLOOD_DZ(43708, 565, 51, new int[] { 77, 89, 94 }, 2500, 20691),
		CHAOS_DZ(43814, 562, 17, new int[] { 35, 74, 86 }, 2500, 20679),
		NATURE_DZ(43711, 561, 18, new int[] { 44, 91, 95 }, 2500, 20681);
	...
	public static void petRoll(Player player, RunecraftingData data) {
		...
		if (Misc.random(1) > 5000 && !player.getItems().hasAnywhere(26899)) {
