package io.zaryx.content.skills.hunter;

import io.zaryx.Server;
import io.zaryx.content.questing.Quest;
import io.zaryx.content.skills.hunter.trap.Trap;
import io.zaryx.content.skills.hunter.trap.TrapProcessor;
import io.zaryx.content.skills.hunter.trap.TrapTask;
...
public final class Hunter {
	...
	public static boolean lay(Player player, Trap trap) {
		...
		if (!Boundary.isIn(player, Boundary.HUNTER_BOUNDARIES)
				...
				&& !Boundary.isIn(player, Boundary.WILDHOME1)
				&& !Boundary.isIn(player, Boundary.WILDHOME2)
				&& !Boundary.isIn(player, Boundary.DZ250)
