...
public class DoubleCannonballSmelting {
    ...
    private static void make(MakeItemDialogue.PlayerMakeItem makeItem) {
        new ItemProductionTickableBuilder()
                ...
                .setItemsProduced(new ImmutableItem(Items.CANNONBALL, 8))
                .setExperiencedGained(new SkillLevel(Skill.SMITHING, 30))
