...
public enum Mineral {
			...
			GOLD(new int[] { 7491, 7458, 9722, 9720, 13707, 14962, 14963, 14964, 13441, 13442, 13443, 8728, 8975, 11370, 11371 }, "gold", 40, 65, 3, 25, 32, 2500, false, generateExclusive(444)),
...
//			COPPERNOTED(new int[] {-1 }, "bronzenoted", 1, 18, 5, 5, 15, 2500, false, generateExclusive(437)),
//			TINNOTED(new int[] { -1 }, "bronzenoted", 1, 18, 5, 5, 15, 2500, false, generateExclusive(439)),
//			IRONNOTED(new int[] {-1 }, "ironnoted", 15, 35, 5, 8, 17, 2500, false, generateExclusive(441)),
//			COALNOTED(new int[] { -1 }, "nonenoted", 30, 50, 3, 15, 29, 2500, false, generateExclusive(454)),
//			GOLDNOTED(new int[] { -1 }, "goldnoted", 40, 65, 3, 25, 32, 2500, false, generateExclusive(445)),
//			MITHRILNOTED(new int[] {-1 }, "mithrilnoted", 55, 80, 3, 40, 35, 2500, false, generateExclusive(448)),
//			ADAMANTNOTED(new int[] {-1 }, "adamantnoted", 70, 95, 2, 50, 37, 2500, false, generateExclusive(450)),
//			RUNENOTED(new int[] { -1 }, "runenoted", 85, 125, 0, 100, 39, 2500, false, generateExclusive(452)),
			...
			//CRYSTAL_TREE(new int[] { 34918, 34917, 34916, 34915, 34914, 34913, 34912 }, "none", 1, 140, -1, -1, 25, 2500, false, generateExclusive(25527)),
	...
	DZ4(new int[] { 36194 }, "none", 1, 4, -1, 25, 30, 10000, false, new MineralReturn() {
		...
		@Override
		public int[] inclusives() {
			return new int[] { 437, 439, 441, 454, 445, 448, 450, 452 };
		}//                    0      1     2     3   4ruby     5    6      7
