...
public class Task {
	...
	/**
	 * Checks to see if the task is really in the wilderness - For Wildymen & Group Wildymen
	 */
	 ...
	 */
	public Task(String[] names, boolean wilderness, int level, int experience, int minimum, int maximum, String[] locations, int[] teleport) {
