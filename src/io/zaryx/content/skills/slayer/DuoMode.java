...
public class DuoMode {
    ...
    private static boolean checkMode(Player player, Player player2) {
         if (player.getMode().equals(Mode.forType(ModeType.WILDYMAN)) || player.getMode().equals(Mode.forType(ModeType.GROUP_WILDYMAN)) && player2.getMode().equals(Mode.forType(ModeType.WILDYMAN)) || player2.getMode().equals(Mode.forType(ModeType.GROUP_WILDYMAN))) {
             return true;
