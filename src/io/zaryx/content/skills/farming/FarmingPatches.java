package io.zaryx.content.skills.farming;
...
public enum FarmingPatches {
	 ...
	 */
	WILDYHOME1(new Position(3454, 3846), new Position(3455, 3847), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.HERB),

	WILDYCAVE1(new Position(2373, 4253), new Position(2374, 4254), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.HERB),
	WILDYCAVE2(new Position(2400, 4271), new Position(2401, 4272), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.HERB),
	WILDYCAVE3(new Position(2388, 4229), new Position(2389, 4230), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.HERB),
	...
	HOME_HERB(new Position(2039, 6007), new Position(2041, 6009), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.HERB),
	HOME_FLOWER(new Position(2035, 6004), new Position(2037, 6006), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.FLOWER),
