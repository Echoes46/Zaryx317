...
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.CHOP_OAK_FREM;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.DAGANNOTH_KINGS;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.FILL_BUCKET;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.KILL_ARMADYL;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.KILL_BANDOS;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.KILL_DAGANNOTH_KINGS;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.KILL_KURASK;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.KILL_ROCK_CRAB;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.KILL_SARADOMIN;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.KILL_SPIRITUAL_MAGE;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.KILL_ZAMORAK;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.MINE_COAL_FREM;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.MIX_SUPER_DEFENCE;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.PRAY_AT_ALTAR;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.TRAVEL_JATIZSOT;
import static io.zaryx.content.achievement_diary.impl.FremennikDiaryEntry.TRAVEL_NEITIZNOT;
