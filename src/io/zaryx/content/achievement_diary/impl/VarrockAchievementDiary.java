...
import io.zaryx.content.achievement_diary.StatefulAchievementDiary;
import io.zaryx.model.entity.player.Player;

import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.ALOT_OF_EARTH;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.APOTHECARY_STRENGTH;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.BECOME_A_DANCER;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.CHAMPIONS_GUILD;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.COOK_LOBSTER;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.DRESS_FOR_SUCESS;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.EARTH_RUNES;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.FILL_VIAL;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.GRAND_TREE_TELEPORT;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.MINE_ESSENCE;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.MINE_IRON;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.OBSTACLE_PIPE;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.POTION_DECANT;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.PRAY_WITH_SMITE;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.PURCHASE_KITTEN;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.SMITH_RUNE_KNIFES;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.SMITH_STEEL_KNIFES;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.SUPER_COMBAT;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.TEA_STALL;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.TELEPORT_ESSENCE_VAR;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.VARROCK_ROOFTOP;
import static io.zaryx.content.achievement_diary.impl.VarrockDiaryEntry.YEWS_AND_BURN;
