...
public class ShootingStars {
    ...
    public static void Tick() {
        ...
        if (DiscordBot.INSTANCE != null) {
            ...
            embed.setTitle("[ WORLD EVENT: SHOOTING STAR ]");
            embed.setImage("https://oldschool.runescape.wiki/images/Shooting_Star_crashing.gif?2f51a");
            embed.setColor(Color.GREEN);
            embed.setTimestamp(java.time.Instant.now());
            embed.addField("There's been a sighting of a star around! Location: " + getLocation(), "'::star'", false);
    ...
    public static void removeStar(boolean success) {
        if (rock != null) {
            ...
            delay = System.currentTimeMillis() + TimeUnit.MINUTES.toMillis(30);
            if (success) {
                new Broadcast("<img=43> @gre@The Shooting star has been completely mined!").submit();
            } else {
                new Broadcast("<img=43> @cya@The dwarfs decided to mine the Shooting star as players didn't!").submit();
            }
        }
    }
