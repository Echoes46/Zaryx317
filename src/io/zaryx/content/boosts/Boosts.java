...
import io.zaryx.content.boosts.other.GenericBoost;
import io.zaryx.content.boosts.xp.ExperienceBooster;
...
public class Boosts {
    ...
    public static void init() {
        ...
        Reflections reflections = new Reflections("io.zaryx.content.boosts", new SubTypesScanner());
