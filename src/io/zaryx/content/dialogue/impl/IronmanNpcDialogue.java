...
import static io.zaryx.model.entity.player.Right.IRONMAN;
import static io.zaryx.model.entity.player.Right.PLAYER;
import static io.zaryx.model.entity.player.Right.ROGUE;
        ...
        Consumer<Player> revert = p -> {
            switch (getPlayer().getMode().getType()) {
                case GROUP_IRONMAN:
                    ...
                    break;
                case GROUP_WILDYMAN:
                    p.getRights().remove(Right.GROUP_WILDYMAN);
                    break;
                case IRON_MAN:
