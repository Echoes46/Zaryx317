...
import io.zaryx.content.skills.firemake.LogData;
...
public class WintertodtActions {
    ...
    public static void burnLogs(Player player, LogData log) {
        // Loop while the player still has logs
        while (player.getItems().getInventoryCount(Wintertodt.BRUMA_ROOT) > 0) {
            // Start the animation
