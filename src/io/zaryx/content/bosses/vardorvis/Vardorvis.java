package io.zaryx.content.bosses.vardorvis;
    ...
    private static void handleSwingingAxes() {
        ...
        int count = Misc.random(2,3);
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (Misc.random(3) == 1) {
                    NPC axe = NPCSpawning.spawnNpc(12227, end.getX(), end.getY(), 0, 0, 35);
                    ...
                    NPC axe = NPCSpawning.spawnNpc(12227, start.getX(), start.getY(), 0, 0, 35);
