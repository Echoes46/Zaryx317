package io.zaryx.content.bosses.fluffie;
...
/*        if (fluffie == null || fluffie.isDead) {
    ...
    public static void updateTargets() {
        ...
        targets = PlayerHandler.getPlayers().stream().filter(plr -> !plr.isDead && plr.getPosition().getAbsDistance(fluffie.getPosition()) <= 25).collect(Collectors.toList());
    }
