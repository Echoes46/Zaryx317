...
public class CannonRepository {
    private static final Logger logger = LoggerFactory.getLogger(io.zaryx.content.dwarfleaguecannon.Cannon.class);
    private static final Map<Position, io.zaryx.content.dwarfleaguecannon.Cannon> CANNON_MAP = new HashMap<>();

    public static boolean add(io.zaryx.content.dwarfleaguecannon.Cannon cannon) {
