...
import io.zaryx.content.combat.effects.damageeffect.impl.TridentOfTheSwampEffect;
...
//                            if (attacker.getSpellId() == Thammaron.COMBAT_SPELL_INDEX && Misc.isLucky(17)) {
//                                attacker.getHealth().increase(damage.getAmount() / 3);
//                                attacker.startGraphic(new Graphic(1547));
//                            }
