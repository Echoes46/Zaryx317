...
public class WeaponDataConstants {
    ...
    public static final int[] SPEARS = {
            ...
            25979, 27291, 25981, 27287, 33204,28988,
            // Hasta
    ...
    public static final int[] CRUSH_SWORDS = {
            ...
            Items.SARADOMIN_SWORD, Items.SARADOMINS_BLESSED_SWORD, Items.SHADOW_SWORD, Items.SPATULA, Items.GILDED_2H_SWORD, 26233, 28537,
    };
    ...
    public static final int[] BATTLEAXES = {
            ...
            Items.DHAROKS_GREATAXE, 5061,
    };

    public static final int[] SCYTHE = {
            Items.SCYTHE, Items.SCYTHE_OF_VITUR, 39001, 25736, 25739, 33161, 33148, 33184, 33203, 28543
    };
    ...
    public static final int[] STAB_SWORDS = {
            ...
            Items.WILDERNESS_SWORD_1, Items.WILDERNESS_SWORD_2, Items.WILDERNESS_SWORD_3, Items.WILDERNESS_SWORD_4, 33202, 33806, 20483
    };
    ...
    public static final int[] WHIPS = {
            Items.ABYSSAL_WHIP, Items.FROZEN_ABYSSAL_WHIP, Items.VOLCANIC_ABYSSAL_WHIP, Items.ABYSSAL_TENTACLE, 26484, 26482, 33162, 39006
    };
    ...
    public static final int[] STANDARD_STAFFS = {
            ...
            Items.SMOKE_BATTLESTAFF, 27624, 27679, 22335, 27679, 20486,
            ...
            Items.TRIDENT_OF_THE_SEAS, Items.TRIDENT_OF_THE_SWAMP, Items.SANGUINESTI_STAFF, 25731, 33149, 33205, 28585, 21198, Items.DAWNBRINGER, Items.STAFF_OF_LIGHT,
            ...
            Items.IBANS_STAFF, Items.IBANS_STAFF_U, Items.ZURIELS_STAFF, 84, 39000
    };
    ...
    public static final int[] BOWS = {
            ...
            Items.BLURITE_CROSSBOW, 26374, 33206, 25916, 25918, 26486, 8880, 26269, 28869,
            //Special Crossbows
            ...
            // bofa
            25865, 25867, 25884, 25888, 25886, 25890, 25892, 25894, 25896, 33058, 33207, 20484, 27655, 33005,
            //corrupted bow
            23855, 23857, 23902,
            //new wildy weapons
            27655, 27610
    ...
    public static final int[] THROWN = {
            ...
            //Special Thrown
            Items.TOKTZ_XIL_UL, Items.CHINCHOMPA_2, Items.RED_CHINCHOMPA_2, Items.BLACK_CHINCHOMPA, Items.TOXIC_BLOWPIPE, 28688, 28919, 28922, 29000
