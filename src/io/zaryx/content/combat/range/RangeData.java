...
import io.zaryx.content.combat.effects.damageeffect.impl.bolts.*;
...
public class RangeData {
	...
	public static final int[] BOWS = { 28869, 19481, 26712, 19478, 12788, 9185, 11785, 21012, 26374, 33206, 26269, 839, 845, 847, 851, 855, 859, 841, 843, 849,
			853, 857, 12424, 22333, 861, 4212, 4214, 4215, 12765, 12766, 12767, 12768, 11235, 4216, 4217, 4218, 4219, 4220, 27655, 27610,
			4221, 4222, 4223, 4734, 6724, 20997, 21902, 22550, 25916, 25918, 26486, 25865, 25867, 25884, 25886, 25888, 33058, 33207, 20484, 25890, 25892, 39000,
			25894, 25896, 33160, 28540, 33005,
			//corrupted bow
			23855, 23857, 23902, 8880, 29000};
	...
	public static final int[] CRYSTAL_BOWS = { 4212, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223,
			//bofa
			25865, 25867, 25884, 25886, 25888, 25890, 25892, 25894, 25896, 33058, 33207, 20484, 22550, 33005,
			//corrupted bow
			23855, 23857, 23902, 39000,
	};

	public static final int[] NO_ARROW_DROP = { 11959, 10033, 10034, 4212, 22550, 27655, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221,
			4222, 4223, 4734, 4934, 4935, 4936, 4937, 25865, 25867, 25884, 25886, 25888, 33058, 33207, 20484, 25890, 25892, 25894, 25896, 33005, 39000,
			//corrupted bow
			23855, 23857, 23902 };

	public static final int[] DOUBLE_SHOT_BOWS = {11235, 12765 , 12766, 12767, 12768, 33005 };
	...
	public static final int[] OTHER_RANGE_WEAPONS = { 11959, 10501, 10033, 10034, 800, 801, 802, 803, 804, 805, 20849, 806, 807, 808,
			...
			6522, 11230, 11231, 11233,11234, 22804, 22634, 21318, 19484, 28919, 28922};
...
//				JAVELINS
				{ 825, 206 }, { 826, 207 }, { 827, 208 }, { 828, 209 }, { 829, 210 }, { 830, 211 }, { 830, 211 },
...
//				BOFA
				...
				{ 27655, 2283},
//				ARROWS
				{ 882, 19 }, { 884, 18 }, { 886, 20 }, { 888, 21 }, { 890, 22 }, { 892, 24 }, /*{ 11212, 1120 },*/ { 21326, 1385 }, { 28991, 211 },
	...
	public static int getRangeProjectileGFX(Player c) {
		...
		if (c.playerEquipment[Player.playerWeapon] == 9185 || c.playerEquipment[Player.playerWeapon] == 26486 || c.playerEquipment[Player.playerWeapon] == 11785 || c.playerEquipment[Player.playerWeapon] == 21012
				|| c.playerEquipment[Player.playerWeapon] == 28869 || c.playerEquipment[Player.playerWeapon] == 21902 || c.playerEquipment[Player.playerWeapon] == 26374 || c.playerEquipment[Player.playerWeapon] == 33206 || c.playerEquipment[Player.playerWeapon] == 25916
				|| c.playerEquipment[Player.playerWeapon] == 25918 || c.playerEquipment[Player.playerWeapon] == 8880 || c.playerEquipment[Player.playerWeapon] == 26269) {
			return 27;
		}
		...
		int[][] data = {
				...
				{ 25888, 1928 }, //purple
				{ 33058, 500 }, //Mage Spell? fuck it
				{ 33207, 660 }, // demon x bow
				{ 20484, 660 }, // demon x bow (en)
				{ 39000, 330 },
				{ 28919, 2728 },
				{ 28922, 2729 },
				{ 27655, 2283},

				{ 4222, 249 }, { 4223, 249 }, { 28991, 1910 }, };
		for (int l = 0; l < data.length; l++) {
	...
	public static boolean wearingCrossbow(Player player) {
		return player.playerEquipment[Player.playerWeapon] == 11785 || player.playerEquipment[Player.playerWeapon] == 9185
				...
				|| player.playerEquipment[Player.playerWeapon] == 26269;
	}
