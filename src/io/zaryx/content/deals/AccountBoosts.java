...
public class AccountBoosts {
    ...
    public static void openInterface(Player player) {
        ...
        player.getPA().sendString(24525, "$"+player.getWeeklyDonated() + " / $50");
        player.getPA().sendString(24526, "$"+player.getWeeklyDonated() + " / $100");
        player.getPA().sendString(24527, "$"+player.getWeeklyDonated() + " / $250");
        player.getPA().sendString(24528, "$"+player.getWeeklyDonated() + " / $500");
        player.getPA().sendString(24529, "$"+player.getWeeklyDonated() + " / $1000");
