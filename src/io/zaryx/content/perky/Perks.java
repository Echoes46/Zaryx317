...
//26547
    ...
    AOE(33233, PerkType.COMBAT),//small aoe effect to all weapons
    MAGICTICK(33222, PerkType.COMBAT),//15% dmg
    MELEETICK(33220, PerkType.COMBAT),//15% dmg
    RANGETICK(33221, PerkType.COMBAT),//15% dmg
    HEALMORE(33231, PerkType.COMBAT),//+5 health when eating
    TRICKSTER(33216, PerkType.COMBAT),//2% to instakill
    PASSXP(33217, PerkType.COMBAT),//2x pass xp
    ...
    RAIDERS_LUCK(33109, PerkType.MISC),//10% Chance to get an extra key $40-- Done
    CLEPTO_MANIAC(33110, PerkType.MISC),//Collect all drop's $ 75-- Done
    MAGIC_PAPER(33111, PerkType.MISC),//Note all drop's $ 50-- Done
    POT_OF_GOLD(33112, PerkType.MISC),//20% increased drop rate $ 150-- Done
    MYSTERY_MADNESS(33113, PerkType.MISC),//double reward's from any mystery box $ 50-- Done
    XPBONUS3(33226, PerkType.MISC),
