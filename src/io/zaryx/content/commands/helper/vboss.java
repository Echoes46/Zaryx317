...
//        PlayerHandler.executeGlobalMessage("@red@[VOTE BOSS]@blu@ the vote boss has spawned south of Dwarven mine, outside Falador!");
    ...
    public static void spawnNPC() {
        ...
        voteboss = NPCSpawning.spawnNpcOld(5126, 2656, 3937, 0, 0, npcType.getHp(), npcType.getMaxHit(), npcType.getAttack(), npcType.getDefence());
        voteboss.getBehaviour().setRespawn(false);
        voteboss.getBehaviour().setAggressive(true);

        voteboss.getBehaviour().setRunnable(true);
        voteboss.getHealth().setMaximumHealth(17500); //Edit vote boss health here
    ...
    public enum Npcs {
        ...
        VOTE_BOSS(5126, "Experiment No.2", 3000, 10, 250, 40);
