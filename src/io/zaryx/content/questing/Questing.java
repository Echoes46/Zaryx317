...
import io.zaryx.content.questing.LearningTheRopes.LearningTheRopesQuest;
import io.zaryx.content.questing.cursePrayers.CursePrayersQuest;
import io.zaryx.content.questing.cursePrayers.WildCursesQuest;
import io.zaryx.content.questing.hftd.HftdQuest;
import io.zaryx.content.questing.MonkeyMadness.MonkeyMadnessQuest;
...
public class Questing {
    ...
    public Questing(Player player) {
        ...
        questList = Collections.unmodifiableList(Lists.newArrayList(
                ...
                new CursePrayersQuest(player),
                new WildCursesQuest(player)
        ));
    }
