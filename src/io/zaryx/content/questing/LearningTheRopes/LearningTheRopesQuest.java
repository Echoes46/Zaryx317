package io.zaryx.content.questing.LearningTheRopes;
...
public class LearningTheRopesQuest extends Quest {
    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            case 0:
                lines.add("To start this quest talk to the Zaryx Guide.");
            ...
            case 5:
            case 6:
                lines.add("You still need to open all 6 interfaces");
            ...
            case 13:
                ...
                lines.add("Guide said it can be found south of home.");
                lines.add("Apparently it looks creepy there...");
                break;
            case 14:
                lines.add("I should bring the certificate back!");
                break;
            case 15:
                lines.add("The guide said to speak with Nomad");
                lines.add("I can dissolve things there!");
                lines.add("Ill come back when i learn how to dissolve.");
                break;
            case 16:
                lines.add("Certificate dissolved, talk to the guide.");
                break;
            case 17:
                lines.add("I learnt how to begin in Zaryx");
                lines.add("Time to feast on my rewards!");
                lines.addAll(getCompletedRewardsList());
                break;
        }
        return lines;
    ...
    public List<String> getCompletedRewardsList() {
        return Lists.newArrayList("2x Mystery box", "3 Experience Lamps.", "1m coins", "100 shark", "10 Super Combats", "1 Quest Point");
    }
            ...
            if (option == 1) {
                if (getStage() == 0) {
                                        ...
                                        player.start(getXerosGuide()
                                                ...
                                                .option(new DialogueOption("Sure, I can start now!", e -> {
                                                            ...
                                                            e.start(getXerosGuide()
                                                                    ...
                                                                    .npc("The information these display", "will help you during your time in Zaryx.")
                    ...
                    player.start(getXerosGuide()
                            ...
                            .npc(DialogueExpression.CALM_TALK, "They are worth a lot of UpgradePoints", "I will reward you if you get the certificates.")
                    ...
                    player.start(getXerosGuide()
                            ...
                            .npc(DialogueExpression.CALM, "For the UpgradePoints!", "Items can be destroyed for points.")
