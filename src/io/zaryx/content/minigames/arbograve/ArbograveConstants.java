...
import io.zaryx.content.minigames.arbograve.rooms.*;
...
public class ArbograveConstants {
    ...
    public static final Position FINISHED_POSITION = new Position(2833, 3280, 0);

    public static final Boundary ARBO_LOBBY = new Boundary(1664, 4224, 1727, 4287);

    public static final Boundary ARBO_ENTRANCE = new Boundary(2821, 3266, 2847, 3280);
