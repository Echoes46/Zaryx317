package io.zaryx.content.minigames.fight_cave;
	...
	public void gamble() {
		...
		if (Misc.random(0,40) == 1) {
			if (!player.getItems().hasAnywhere(25898, 25900) && !player.getItems().hasInBank(25898) && !player.getItems().hasInBank(25900)) {
				player.getItems().addItemUnderAnyCircumstance(33334, 1);
				PlayerHandler.executeGlobalMessage("[@red@Slayer@bla@] @cr20@<col=255> " + player.getDisplayName() + "</col> received Jads tooth from <col=255>TzTok-Jad</col>.");
			}
		}
