package io.zaryx.content.minigames.bounty_hunter;
...
import io.zaryx.content.minigames.bounty_hunter.events.TargetDelay;
import io.zaryx.content.minigames.bounty_hunter.events.TargetSelector;
...
public class BountyHunter extends CycleEvent {
	...
	public boolean isTarget(int playerAttackingIndex) {
		Player player = PlayerHandler.players[playerAttackingIndex];
