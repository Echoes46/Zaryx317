...
import io.zaryx.util.logging.player.CompletedTobLog;
        ...
        if (getNpcId() == VERZIK_SUSPENDED_ID) {
            ...
            setNpcAutoAttacks(Lists.newArrayList(
                    new NPCAutoAttackBuilder()
                            ...
                            .setDistanceRequiredForAttack(14)
                            .setProjectile(new ProjectileBaseBuilder().setProjectileId(1594).setSendDelay(3).createProjectileBase())
        ...
        CycleEventHandler.getSingleton().addEvent(new Object(), new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
                ...
                if (container.getTotalExecutions() == 9) {
                    safeSpotList.forEach(pos -> new ProjectileBaseBuilder()
                            .setProjectileId(1596)
                            .createProjectileBase()
                            .createTargetedProjectile(Verzik.this, pos)
                            .send(getInstance()));
                    safeSpotList.forEach(pos -> new NPCAutoAttackBuilder()
                            .setHitDelay(6));
                    ...
                    getInstance().getPlayers().forEach(plr -> {
                        ...
                        if (safeSpotList.stream().noneMatch(pos -> plr.getPosition().equals(pos))) {
                            plr.appendDamage(40 + Misc.trueRand(20), Hitmark.HIT);
                        } else {
