...
import io.zaryx.content.minigames.tob.rooms.RoomFiveXarpus;
import io.zaryx.content.minigames.tob.rooms.RoomFourSotetseg;
import io.zaryx.content.minigames.tob.rooms.RoomOneMaiden;
import io.zaryx.content.minigames.tob.rooms.RoomSevenTreasure;
import io.zaryx.content.minigames.tob.rooms.RoomSixVerzik;
import io.zaryx.content.minigames.tob.rooms.RoomThreeNylocas;
import io.zaryx.content.minigames.tob.rooms.RoomTwoBloat;
...
public class TobConstants {
    ...
    public static double getHealthModifier(final int size) {
        double baseModifier = 1.1; // Base 20% increase in health

        // For each player beyond 1, double the modifier
        double playerModifier = 0.25 * size;

        return baseModifier * playerModifier;
    }
}
