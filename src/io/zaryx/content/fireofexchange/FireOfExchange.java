...
import static io.zaryx.content.fireofexchange.FireOfExchangeBurnPrice.getBurnPrice;
...
*/
        ...
        c.sendMessage("Upgrader takes your @blu@" + ItemAssistant.getItemName(c.currentExchangeItem) + "@bla@ and gives back @blu@" + Misc.formatCoins(exchangePrice) + " Upgrade points!");
    ...
    public static int getExchangeShopPrice(int id) {
        switch (id) {
            ...
            case 20718: //Burnt Pages
                return 500;
            case 12934: //Burnt Pages
                return 500;
            case 2: //Burnt Pages
                return 500;
            case 26358: //Burnt Pages
                return 2_500_000;
            case 26360: //Burnt Pages
                return 2_500_000;
            case 26362: //Burnt Pages
                return 2_500_000;
            case 26364: //Burnt Pages
                return 2_500_000;
        }
