...
public class Trade {
	...
	private static ConcurrentHashMap<String, Stack> map = new ConcurrentHashMap<String, Stack>();
	...
	/**
	 * Fetches the state. State can be 0 or 1
	 * Basically whether or not the user received (0) the item
	 * or has given (1) the item.
	 * @return
	 */
